...
\author[Krist\'of Rozgonyi]{\textbf{Krist\'of Rozgonyi{\Large \inst{1,}\inst{2}}}\\ {\Large Survey CEO: Martin Meyer{\large \inst{1,}\inst{2}}}} %Note that the inst signs fontsize have to be set here to match with author size 
\date[today]{\today}
